...
<head>
    ...
    <script src="script/script_bl.js"></script>
...
<div class="container">
    ...
    <div id="diary">
        <img class="fatCat2" src="img/bliez.gif" height="250">
        <h1>Приступим!</h1>
        <div class="accordeon">
            <div class="acc-head">
            ...
            <div class="acc-head">
                <b>Какие мысли и / или образы у вас возникли? На сколько вы
                    ...
                    каждой / каждом из них? К какой категоии когнитивных искажений они относятся?
            ...
            <div class="acc-body">
                ...
                <img class="wheel_emotion" src="img/wheel_of_the_emotion.jpg" width="550">
