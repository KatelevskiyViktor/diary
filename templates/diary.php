...
<div id="diary">
              ...
              <div class="accordeon">
                     <div class="acc-head">
                            <b>1. Введите дату события.</b>
                     </div>
                     <div class="acc-body">
                            <input name="daterec" value="<?php echo date('Y-m-d'); ?>" class="dataDairy textMode" type="date">
                     </div>
                     <div class="acc-head">
                            <b>2. Какое событие, поток мыслей, мечтания или воспоминания привели
                                   к возникновению неприятной эмоции?</b>
                     </div>
                     <div class="acc-body">
                    <span class="headerExample hE1">Пример?
                            Нажми меня ;)</span></b><br>
                            <span class="example e1"> Подумала о том, чтобы пригласить Сашу на кофе.</span>
                            <textarea name="situation" class="textMode1"></textarea>
                     </div>
                     <div class="acc-head">
                            <b>3. Какие мысли и / или образы у вас возникли? На сколько вы
                                   были убеждены (0 - 100%) в
                                   каждой / каждом из них? К какой категории когнитивных искажений они относятся?
                                   [по желанию]:К какой категории когнитивных искажений относится ваша мысль и / или образ?</b>
                     </div>
                     <div class="acc-body">
                            ...
                            <img class="mental_error" src="<?= PATH ?>/img/mental_error2.png" width="550">
                            <textarea name="cognition" class="textMode1"></textarea>
                     </div>
                     <div class="acc-head">
                            <b>4. Какие эмоции (грусть / тревога / злость и т.д.) у вас возникли в тот момент?
                                   Насколько сильными (0 - 100%) были эти эмоции?</b>
                     </div>
                     <div class="acc-body">
                            <span class="headerExample hE4">Пример? Нажми меня ;)</span><br>
                            <span class="example e4"> Грусть (75%).<br></span>
                            <span class="headerExample we">Хочешь узнать название своей эмоциии, жми сюда ;)</span>
                            <img class="wheel_emotion" src="<?= PATH ?>/img/wheel_of_the_emotion.jpg" width="550">
                            <textarea name="reaction" class="textMode1"></textarea>
                     </div>
                     <div class="acc-head">
                            <b>5. Используя вопросы ниже, чтобы сформулировать ответ на автоматические мысли:<br>
                    ...
                    Что случится, если я изменю свой образ мысли?<br>
                    ...
                    6) Если бы _____ [имя друга] попал в аналогичную ситуацию и рассуждал так же, <br>
                     ...
                     <div class="acc-head">
                            <b>6. Насколько вы теперь убеждены в каждой из автоматических мыслей?
                                   Какие эмоции вы испытываете теперь? Насколько они сильны теперь (0-100%)?
                                   Что вы сделаете (или уже сделали)?</b>
                     </div>
                     <div class="acc-body">
                    <span class="headerExample hE6">Пример?
                            Нажми меня ;)</span></b><br>
                            <span class="example e6">
                        Автоматическая мысль (50%)<br>
                        Грусть (50%)<br>
                        Я его приглашу<br>
