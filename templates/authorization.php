...
<head>
    ...
    <script src="<?= PATH ?>/script/jquery.cookie-1.4.1.min.js"></script>
    <script src="<?= PATH ?>/script/functions.js"></script>
    <script src="<?= PATH ?>/script/script_auth.js"></script>
</head>
<body>
<div class="bubay">
    ...
    <div class="form-panel one">
        ...
        <div class="form-content">
                ...
                <div class="form-group">
                    ...
                    <a class="form-recovery" href="<?= PATH ?>/changepass">Забыли пароль?</a>
        ...
        <div class="form-content">
                <div class="form-group">
                    ...
                    <input type="text" id="username_reg"
                           class="username reg_user" name="username_reg" />
                    <p class="hid er">Имя должно быть не менее 3-х сиволов на латинице</p>
                </div>
                <div class="form-group pass1">
                    <label for="password">Пароль</label>
                    <input type="password"
                           class="password1 reg_pass" id="password_reg" name="password_reg"/>
